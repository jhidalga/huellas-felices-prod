            ...
            <form method="POST"
                ...
                <div>
                    ...
                    <select id="especie"
                        ...
                        <option value="gato"
                            disabled
                            {{ $mascota->especie == 'gato' ? 'selected' : '' }}>
                            Gato (no disponible)
                        </option>

                        <option value="perro"
                            {{ $mascota->especie == 'perro' ? 'selected' : '' }}>
                            Perro
                        </option>
                ...
                <div>
                    ...
                    @if($mascota->foto)
                        <div class="flex items-center gap-4 mb-3 p-3 bg-[#f7f5f0] rounded-xl border border-[#d9ddd0]">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm text-[#1e2e1a] font-medium truncate">
                                    {{ $mascota->nombre }}
                                </p>
                            </div>
                        </div>
                    @else
                        <div class="flex items-center gap-3 mb-3 p-3 bg-[#f7f5f0] rounded-xl border border-[#d9ddd0]">
                            ...
                            <div
                                class="w-16 h-16 bg-[#eef5e8] border border-[#c8d9be] rounded-xl flex items-center justify-center text-2xl shrink-0">
                                🐾
                            </div>
